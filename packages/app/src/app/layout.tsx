...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || 'https://www.beatschain.app'),
  ...
  openGraph: {
    ...
    url: process.env.NEXT_PUBLIC_APP_URL || 'https://www.beatschain.app',
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_APP_URL || 'https://www.beatschain.app'}/api/og?title=${encodeURIComponent('BeatsChain')}&description=${encodeURIComponent('Web3 Beat Marketplace')}`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: 'BeatsChain - Web3 Beat Marketplace',
    description: 'Web3 beat marketplace - Buy beats as NFTs with crypto. BeatNFT credits, automatic royalties, true beat ownership. SA producers, global reach.',
    images: [`${process.env.NEXT_PUBLIC_APP_URL || 'https://www.beatschain.app'}/api/og?title=${encodeURIComponent('BeatsChain')}&description=${encodeURIComponent('Web3 Beat Marketplace')}`],
  },
  robots: {
    index: true,
    follow: true,
